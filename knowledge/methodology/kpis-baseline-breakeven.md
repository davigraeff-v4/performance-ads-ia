# KPIs, Baseline e Breakeven

> Metodologia interna.

## Contrato de KPI

Todo KPI precisa de nome, definição, fórmula, unidade, fonte, janela, denominador e limitação.

## Fórmulas básicas

- CTR = cliques relevantes / impressões.
- CPC = investimento / cliques relevantes.
...
Usar período representativo e comparável. Registrar mudanças estruturais e sazonalidade. Não misturar contas, moedas, eventos ou modelos de atribuição.
