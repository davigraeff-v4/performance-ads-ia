<!-- Referência do módulo `planejamento`; etapa `planejamento/google-ads-plano-de-construcao` nas rotas. -->

# Plano de Construção Google Ads

## Pré-requisitos

1. Etapas `contexto-cliente`, `mensuracao`, `diagnostico/metas-e-linha-de-base`, `revisor/google-ads`, `planejamento/google-ads-estrategia`, `planejamento/google-ads-arquitetura`, `planejamento/google-ads-orcamento-lances-e-conversoes` e `planejamento/google-ads-criativos-e-pagina` concluídas conforme o escopo.
2. Etapa `planejamento/google-ads-palavras-chave` concluída quando houver keywords, search themes ou validação de demanda.
